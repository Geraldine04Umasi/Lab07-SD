 ...
 * 
 */
@WebServiceClient(name = "SOAPImplService", targetNamespace = "http://soap.rosamarfil.es/", wsdlLocation = "http://localhost:1516/WS/Users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPIMPLSERVICE_QNAME = new QName("http://soap.rosamarfil.es/", "SOAPImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1516/WS/Users?wsdl");
    ...
    public SOAPI getSOAPImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.rosamarfil.es/", "SOAPImplPort"), SOAPI.class, features);
    }
